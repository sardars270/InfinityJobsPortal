...
import com.example.infinityjobportal.AddSkillsActivity;
...
public class MyProfile extends Fragment {
    ...
    TextView editExperienceSection, editEducationSection, editInterestSection, editSkillsSection, editSkills;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editSkills = root.findViewById(R.id.openSkills);
        ...
        // setup recycler view
        recyclerViewSkill = root.findViewById(R.id.recyclerSkills);
        recyclerViewSkill.setHasFixedSize(true);
        adapterSkill = new MySkillAdapter(getContext(), skillList);
        recyclerViewSkill.setLayoutManager(new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false));
...
//        StorageReference imageRef = storageReference.child("Images/my.png");
        ...
        editSkills.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getContext(), AddSkillsActivity.class));
