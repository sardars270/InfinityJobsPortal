...
public class LOEAdapterProfile extends RecyclerView.Adapter<LOEAdapterProfile.ViewHolder> {
    private LOEModel loeModel;
    private ArrayList<LOEModel> loeModelArrayList = new ArrayList<>();
    private Context context;
    FirebaseFirestore db;

    public LOEAdapterProfile(ArrayList<LOEModel> o, Context context, String af) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_exp_outer_profile, parent, false);
