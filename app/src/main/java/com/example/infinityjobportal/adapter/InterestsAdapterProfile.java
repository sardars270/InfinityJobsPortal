...
public class InterestsAdapterProfile extends RecyclerView.Adapter<InterestsAdapterProfile.ViewHolder> {
    ...
    public InterestsAdapterProfile(ArrayList<InterestsModel> o, Context context, String af) {
        this.l = o;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_interests_profile, parent,false);
