...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.homeFragment, R.id.myJobsFragment, R.id.postJobFragment,R.id.myCompaniesFragment, R.id.postedJobsFragment, R.id.aboutUsFragment, R.id.myProfileFragment, R.id.queriesFragment)
